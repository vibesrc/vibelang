...
impl<'ctx> Codegen<'ctx> {
    ...
    /// Create a socket: sys_socket(domain: i32, type: i32, protocol: i32) -> i32
    ...
    /// Bind socket to address: sys_bind(sockfd: i32, addr: *u8, addrlen: i32) -> i32
    ...
    /// Listen for connections: sys_listen(sockfd: i32, backlog: i32) -> i32
    ...
    /// Accept a connection: sys_accept(sockfd: i32, addr: *u8, addrlen: *i32) -> i32
    ...
    /// Connect to address: sys_connect(sockfd: i32, addr: *u8, addrlen: i32) -> i32
    ...
    /// Send data: sys_send(sockfd: i32, buf: *u8, len: i64, flags: i32) -> i64
    ...
    /// Receive data: sys_recv(sockfd: i32, buf: *u8, len: i64, flags: i32) -> i64
    ...
    /// Send data to address: sys_sendto(sockfd: i32, buf: *u8, len: i64, flags: i32, dest_addr: *u8, addrlen: i32) -> i64
    ...
    /// Receive data from address: sys_recvfrom(sockfd: i32, buf: *u8, len: i64, flags: i32, src_addr: *u8, addrlen: *i32) -> i64
    ...
    /// Set socket option: sys_setsockopt(sockfd: i32, level: i32, optname: i32, optval: *u8, optlen: i32) -> i32
    ...
    /// Get socket option: sys_getsockopt(sockfd: i32, level: i32, optname: i32, optval: *u8, optlen: *i32) -> i32
    ...
    /// Shutdown socket: sys_shutdown(sockfd: i32, how: i32) -> i32
